...
<fieldset title="销售属性">
    ...
    <div id="jiage">
        ...
        <div class="form-group"><label
                class="col-md-2 col-sm-2 control-label">联创</label>
        ...
        <div class="form-group"><label
                class="col-md-2 col-sm-2 control-label">二级代理</label>
            <div class="col-md-6 col-sm-6"><input type="text" id="7"
                                                  class="form-control" placeholder="0" value="${price[7]}">
            </div>
        </div>
        <div class="form-group"><label
                class="col-md-2 col-sm-2 control-label">特约</label>
            <div class="col-md-6 col-sm-6"><input type="text" id="8"
                                                  class="form-control" placeholder="0" value="${price[8]}">
            </div>
        </div>
        <div class="form-group"><label
