                            ...
                            <form id="default" class="form-horizontal" onsubmit="javascript:confirm()">
                                <fieldset title="商品信息">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6">
                                            <select class="form-control m-bot15" name="serise" id="page">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6">
                                        <select class="form-control m-bot15" name="serise" id="type">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-6">
                                            <select class="form-control m-bot15" name="serise" id="status">
